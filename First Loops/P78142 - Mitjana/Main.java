...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        float num = 0; // Almacena numeros introducidos
        int contador = 0; // Cuenta los numeros introducidos para hallar la media
        float resultado; // Almacena el resultado en decimales
        float suma = 0; // Almacena la suma de los números introducidos
        
        while(teclado.hasNextInt()){
            num = teclado.nextInt(); // Almacena nº introducido por teclado
